 ...
 * @author 陈靖
 */
public class PullToRefreshLayouts extends RelativeLayout
{
	...
	public PullToRefreshLayouts(Context context)
	{
		super(context);
		initView(context);
	}

	public PullToRefreshLayouts(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		initView(context);
	}

	public PullToRefreshLayouts(Context context, AttributeSet attrs, int defStyle) {
...
//			}
			...
			AsyncTask<Integer, Float, String>
	{
		...
		protected void onPostExecute(String result)
		{
			...
			// 刷新操作
			if (mListener != null)
				mListener.onRefresh(PullToRefreshLayouts.this);
			hide();
		}
...
//	}
	...
	public interface OnRefreshListener
	{
		 ...
		 * 刷新操作
		 */
		void onRefresh(PullToRefreshLayouts pullToRefreshLayout);
