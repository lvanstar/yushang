 ...
 */
public class MiddleDialog3<E> extends Dialog{
    private E bean;
    private int position;
    private onButtonCLickListener listener;
    public MiddleDialog3(final Context context, String str, final String str2, final onButtonCLickListener<E> listener, int theme) {
        super(context, theme);
        View view = View.inflate(context, R.layout.dialog_middle3, null);
        setContentView(view);
        ...
        view.findViewById(R.id.phone).setOnClickListener(new View.OnClickListener() {//号码
            @Override
            public void onClick(View v) {
