 ...
 */
    ...
    public class Utils {
        ...
        private static Utils chineseSpelling = new Utils();
        ...
        public static String trans2PinYin(String str) {
            return Utils.getInstance().convertAll(str);
        }
...
//     * @return
//     */
//    public static String parseSortKey(String sortKey) {
////        sorttoken token = new sorttoken();
//        String wholeSpell = sortKey;
//        if (sortKey != null && sortKey.length() > 0) {
//
//            Log.i("lzz","直："+wholeSpell);
//            //其中包含的中文字符
...
//            }
//        }
//        Log.i("lzz","直1111111111："+wholeSpell);
//        return wholeSpell;
//    }