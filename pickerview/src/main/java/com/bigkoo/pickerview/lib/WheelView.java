...
public class WheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //中间两条横线
        canvas.drawLine(0.0F, firstLineY-6, measuredWidth, firstLineY-6, paintIndicator);
        canvas.drawLine(0.0F, secondLineY+5, measuredWidth, secondLineY+5, paintIndicator);
        //单位的Label
        if(label != null) {
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                if (translateY <= firstLineY && maxTextHeight + translateY >= firstLineY) {
                    ...
                    canvas.drawText(contentText, drawCenterContentStart, maxTextHeight - CENTERCONTENTOFFSET+5, paintCenterText);
