...
import com.jcodecraeer.xrecyclerview.progressindicator.ObservableScrollable;
import com.jcodecraeer.xrecyclerview.progressindicator.OnScrollChangedCallback;

import java.util.ArrayList;
import java.util.List;

public class XRecyclerView extends RecyclerView implements
    ...
    private void init(Context context) {
        ...
        mFootViews.get(i).setVisibility(GONE);
    }
